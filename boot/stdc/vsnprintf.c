...
static int print_wchar(char *buf, size_t len, struct fmt_spec spec, va_list *args)
{
...
static int print_char(char *buf, size_t len, struct fmt_spec spec, va_list *args)
{
    int left = 0;
    int char_cnt = 0;
    char ch;
...
static int print_str(char *buf, size_t len, struct fmt_spec spec, va_list *args)
{
    int left = 0;
    int char_cnt = 0;
    const char *str;
...
static int print_int(char *buf, size_t len, struct fmt_spec spec, va_list *args)
{
    int is_signed = 0;
    int char_cnt = 0;
...
static int print_float(char *buf, size_t len, struct fmt_spec spec, va_list *args)
{
